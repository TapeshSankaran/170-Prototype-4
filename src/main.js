...
>>>>>>> Stashed changes
	...
	damageShip(ship, damage) {
		...
		// ========== POWER-UP CODE START ==========
		// Check for shield protection (player only)
		if (ship === this.ship && this.shieldCharges > 0) {
			this.shieldCharges--;
			// Shield blocks the damage - return without dealing damage
			return;
		}
		// ========== POWER-UP CODE END ==========
...
>>>>>>> Stashed changes
	...
	update() {
		...
		// ========== POWER-UP CODE START ==========
		// Apply fire rate boost if active (halves shoot time after wave difficulty)
		if (this.fireRateBoostActive) {
			this.shootTime = this.shootTime * 0.5;
		}
		// ========== POWER-UP CODE END ==========
		// ========== WAVE DIFFICULTY CODE END ==========
